...
## Challenge Overview
This project is an **Agentic AI application** developed for the AI Driven Compliance Screening System Challenge. The system leverages an agentic framework to perform real-time compliance screening of orders, ensuring regulatory and legal adherence.
...
1. **Clone the repository:**
   ...
   cd "AI Driven Compliance Screening System Challenge"
   ```
